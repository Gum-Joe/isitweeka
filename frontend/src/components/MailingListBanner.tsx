...
export default class Banner extends React.Component {
	...
	render() {
		return (
			<div style={{ display: "flex", position: "sticky", width: "100vw", height: 80, padding: "0 5vw", margin: 0, top: 0, bottom: 0, justifyContent: "center", alignItems: "center", gap: 16, boxSizing: "border-box", background: "#000" }}>
