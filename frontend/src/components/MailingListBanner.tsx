...
export default class Banner extends React.Component {
	...
	render() {
		return (
			<div className={"sosumi"} style={{ display: "flex", position: "sticky", width: "100vw", height: 80, padding: "0 5vw", margin: 0, top: 0, bottom: 0, justifyContent: "center", alignItems: "center", gap: 16, boxSizing: "border-box", color: "#000", background: "#FFF" }}>
				...
				<form style={{ display: "flex", flexDirection: "row", gap: 16, margin: "auto 0", fontWeight: 500, fontSize: "1em" }}>
					<div style={{ display: "flex", flexDirection: "row", gap: 16 }}>
						...
						<input style={{ margin: 0 }} id="name-input" type="text" />
					</div>
					<div style={{ display: "flex", flexDirection: "row", gap: 16 }}>
						<label style={{ margin: "auto 0" }} htmlFor="email-input">Email:</label>
						<input style={{ margin: 0 }} id="email-input" type="email" />
					</div>
